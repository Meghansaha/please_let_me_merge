...
Today this talk will focus on things that may be useful to those of you who are right...
:::
...
::: notes
..here in the middle of this git learning process. So, I’m assuming you’ve got Git set up correctly on your system, have pushed and pulled things to and from a repo, and have basic knowledge of Git merging. I hope I can plant the seed to help you overcome the second learning curve if you’re feeling stuck here.
<br>
B/c At one point, I felt stuck too and thought that understanding Git merges and conflicts was impossible
<br>
but it started to make sense when I realized that using Git collaboratively is a lot like driving.
...
<br>
- Usually via pushes and pulls (those are not the only ways)
<br>
- Different types that are more common
<br>
...
:::{.notes}
- One i haven't used that much yet
<br>
...
<br>
- merge essential -> Git's functionality of version control when collaborating
<br>
...
- Not too bad (within file/or to the file name/org)<br>
- But, there has to be a reason we're all so afraid of merge conflicts<br>
- Let's actually look at an overly simple example of a scenario that happened at my job to see if  **really scary or not...**
:::
...
::: {.notes}
- both working in repository on different deliverables
...
::: {.notes}
- coworker #1 had an easy go
- changed the config file when done
:::
...
<br>
let's look at the conflicted files
:::
