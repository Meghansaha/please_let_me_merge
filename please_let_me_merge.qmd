...
- reduces miscommunication<br>
- allows for team -> plan about workflow/review process
:::
...
- obi conflict mitigation -> Branch protection rules - communicate that someone attempted to go against intended workflow<br>
...
- tools can be great - do you want to resolve a conflict with HTML files manually when you could select the version you want in a pretty interface? then you can use a third party..
:::
...
Be thoughtful <span class="highlight">before</span>, <span class="highlight">during</span>, and <span class="highlight">after</span> your coding sessions
  ...
  - <span class="highlight">After</span> You Code:
    ...
    - You are Reviewer #1
    - Ensure your work is user-friendly by leaving a decent paper trail
