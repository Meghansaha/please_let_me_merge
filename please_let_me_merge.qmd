...
- spent time being scared<br>
- need to be scared of ME (flows and process)<br>
- You may not realize..
:::
...
- As we're all aware, Not a lot of time left -> can't get into too much detail about the following topics<br>
- Links on the slides are active and this information is on my github for you to review later<br>
...
![](images/gh_qr.png){style="float:right; width:20%; margin-top:-19%; margin-right:-17%;"}
:::

:::{.notes}
- basic, obvious questions, but..
- explicit convos reduce miscomms<br>
- convos allows for team to plan workflow and code review process
:::
...
![](images/gh_qr.png){style="float:right; width:20%; margin-top:-2%; margin-right:-17%;"}
:::
...
- dont have to annotate everything...<br>
    -   High-level description of outputs || Complicated wrangling operations<br>
    -   Contextual information || Justification of programming decisions
...
- But know, these are active links and in my everday toolkit<br>
...
Be thoughtful <span class="highlight">before</span>, <span class="highlight">during</span>, and <span class="highlight">after</span> your coding sessions
  ...
  - <span class="highlight">During</span> Your Coding:
    ...
    - Keep commits informative add amendments
    - Use [git stashes](https://www.atlassian.com/git/tutorials/saving-changes/git-stash) when there's ✌🏾emergencies✌🏾 
    - Consider "Branch Drift" risk

![](images/gh_qr.png){style="float:right; width:20%; margin-top:-25%; margin-right:-17%;"}
:::

:::{.notes}
- commit as often as you want, but push sparingly<br>
- but related tasks youd put in sep commits can just be in one with amendments<br>
- It'll make for clean history, improve clarity for collaborators<br>
- Stashes are great for unfinished work that doesn't meet your team's workflow standards yet<br>
- Branch drift risk: - don't let perfectionism hurt you, work may be good enough to be merged if documentted and annotated properly
:::
...
Be thoughtful <span class="highlight">before</span>, <span class="highlight">during</span>, and <span class="highlight">after</span> your coding sessions
  ...
  - <span class="highlight">After</span> You Code:
    ...
    - You are Reviewer #1
    - Ensure your work is user-friendly and reproducible
...
:::{.notes}
- Big way to avoid conflicts is to leave no trace when done (pushing commits, stashing unfinished work)<br>
- Before sending code to some else, check it yourself and sleep on it if able, b/c<br>
- ensure your work is clear, reproducible, and documented by...<br>
...
I hope that when you're back home, you'll return to these slides
