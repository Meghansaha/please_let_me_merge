...
but might be a little hesitant like I once was to even deal with merges conflicts.<br>
...
<br>
- although sometimes, using the terminal makes sense..
<br>
...
:::{.notes}
- And the reverse<br>
merges allow for safe modifications to work when working w/ others<br>
- That's all a merge is... seems simple...<br>
- why scary?
:::
...
The actual conflict
<br>
If this is giving you anxiety, it's ok
<br>
may help -> every conflict --> 3 components
:::
...
:::{.notes}
- Don't be bullied into getting flustered for "emergencies"<br>
- usethis -> helpful when working with PRs
:::
