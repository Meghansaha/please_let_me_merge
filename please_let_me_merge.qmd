...
::: notes
You have the initial challenge of just installing, let alone, learning to use Git, **but then you have the..**
:::
...
<br>
- more comfortable you become w/ git, youll realize terminal makes sense sometimes
<br>
- But just do what makes sense for your skilld & sitch
<br>
...
- merging of two local branches w/o repo interaction
<br>
What's important:<br>
- No matter the merge
<br>
...
<br>
- important b/c ->safe modifications to work
<br>
- That's all it is... seems simple...<br>
- So if a merge is **simple in theory...**
:::
...
The actual conflict
<br>
If this is giving you anxiety, it's ok, just know
<br>
every conflict --> 3 components
:::
...
::: {.notes}
Usually name of commit or branch YOU are on and trying to merge<br>
HEAD is wherever you are in commit history<br>
then a conflict marker that has "less-than" signs (start of conflict)<br>
Then code: Coworker # 2s branch
:::
...
:::{.notes}
- Cycle thru the frags (the below notes come after - work/proc)
...
Be thoughtful about how to <span class="highlight">start</span>, <span class="highlight">do</span>, and <span class="highlight">end</span> your coding sessions
  ...
  - To <span class="highlight">Start</span>:
    ...
    - On existing branches, ALWAYS pull first
...
Be thoughtful about how to <span class="highlight">start</span>, <span class="highlight">do</span>, and <span class="highlight">end</span> your coding sessions
  ...
  - To <span class="highlight">Start</span>:
    ...
    - Use thoughtful branch names when initializing 
...
Be thoughtful about how to <span class="highlight">start</span>, <span class="highlight">do</span>, and <span class="highlight">end</span> your coding sessions
  ...
  - To <span class="highlight">Do</span>:
    ...
    - Commits can act as stashes, but inform others
...
:::{.notes}
- maybe you need to learn more about git 
...
:::{.notes}
you will eventually get to a point where you say...
:::

## I Got This {.section-header background-image="images/5.png" background-size="contain" background-color="#1a1a1a"}

::: {.notes}
Just like with parenting, travelling, and most difficult things in life, there's no tried and true method to success that anyone can just follow when it comes to learning how to resolve git merge conflicts. You'll find plenty of resources explaining the basic concept of conflict resolution, but it's a tricky thing to teach because while most real-world conflicts are simple, all of them require some type of contextual knowledge. The only truly reliable method to learning how to to do certain things like driving or resolving git merge conflicts is through preparation, practice, and exposure.
...
::: {.notes}
...scene is probably what it feels like right now, but if you take the time to let the...
:::

## {.section-header background-image="images/2_end.png" background-size="contain" background-color="#1a1a1a"}

::: {.notes}
dust settle and regain your bearings, you and your team can start preparing to work more efficiently by improving gaps in your communication, workflow, and knowledge..
:::
...
::: {.notes}
...you'll realize you don’t have to plead with git to let you merge anymore because You have the power to control the journey your work takes to get... 
:::
