...
<br>
- more comfy -> terminal makes sense
<br>
- But just do what makes sense for your sitch
...
::: {.notes}
- coworker 1 is about done
<br>
- diff. deliverable -> save new vs. config file
<br>
- while cw 2 is still working with the orig vs.
:::
...
::: {.notes}
- poor cw 2 is stuck in iteration hell
<br>
- takes a while, when done, changes config file
:::
...
::: {.notes}
when Cw2 finished so much time passed, 
<br>
...
<br>- How do we resolve this conflict?
...
:::{.notes}
it's OK<br>
- think back ... had to ask which date<br>
- cw2 was expert and knew the answer...
- 2 ways to "tuck and roll"
:::
## Resolving Git Merge Conflicts {.content-header background-image="images/content_back.png" background-size="contain" background-color="#1a1a1a"}
...
:::{.notes}
- if you have a conflict - you can't do anything else<br>
...
- when ready tackle, **2nd thing to do is..**
:::
...
::: {.column width="50%"}
  - Figure out what is causing the conflict and where
:::

::: {.column width="50%"}
![](images/conflict_message.png){width=100%}
:::
:::
:::

:::{.notes}
- If using terminal or rstudio<br>
- git already tells you<br>
- **more info...**
:::
...
::: {.column width="50%"}
  - Figure out what is causing the conflict and where
  - You can use the terminal `git status`
:::
...
<br>
![](images/web_resolve.png){width=100%}

:::

:::{.notes}
- sends you here<br>
- all conflicted files here
:::
...
<br>
![](images/unlucky_resolve.png){width=90%}

:::

:::{.notes}
- If not lucky, it's greyed out<br>
- gotta resolve it elsewhere
- this sucks, but this example of why you shouldn't be scared...
:::
## Resolving Git Merge Conflicts {.content-header background-image="images/content_back.png" background-size="contain" background-color="#1a1a1a"}
...
:::{.notes}
- Have a theory<br>
- we think git is so smart/complex<br>
- it's amazing, but more credit than due<br>
- smart enough to throw a conflict but not  to resolve<br>
- human steps in == CONTROL<br>
- Something I had a hard time wrapping my head around<br>
- what git was expecting of me ... let's look at ex of what git expects you to do...<br>
:::

## Resolving Git Merge Conflicts {.content-header background-image="images/content_back.png" background-size="contain" background-color="#1a1a1a"}

::: content
![](images/code_snip1.gif){width=90%}
:::

:::{.notes}
- manually edit the file, this case pick the right date
- ~narrate what's happening here~
- idk why, but i never realized this is all git wanted
- fears or more rejection
- did not realize how primitive the situation here is because...
:::
...
:::{.notes}
Now what do I mean? Let's talk about it<br>
one of the hardest pills to **swallow was realizing...**
:::

## Conflicts are Not Git Problems {.section-header background-image="images/the_truth1.png" background-size="contain" background-color="#1a1a1a"}

:::{.notes}
- spent time being scared
:::

## Conflicts are Not Git Problems {.section-header background-image="images/the_truth2.png" background-size="contain" background-color="#1a1a1a"}

:::{.notes}
- really needed to be scared of myself
:::
...
- But you can lessen the frequency and severity of them
:::
...
- Learn what you need to, how you need to: (Readers)
...
- Learn what you need to, how you need to: (Doers)
  - [saperlipopette Package](https://maelle.github.io/saperlipopette/index.html)
  - [Oh S%@t Git](https://ohshitgit.com/) | [Oh Danggit Git](https://dangitgit.com/en)
...
- Collaborating with others requires good communication
