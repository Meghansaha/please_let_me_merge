...
- Let's actually look at some examples of some conflicts to see if these things are **really scary or not...**
:::
...
## Simple Merge Conflict Example {.section-header background-image="images/conflict_vis_6.png" background-size="contain" background-color="#1a1a1a"}
...
## {.section-header background-image="images/1_end.png" background-size="contain" background-color="#1a1a1a" transition="slide" transition-speed="slow"}
## {.section-header background-image="images/2_end.png" background-size="contain" background-color="#1a1a1a" transition="fade-in fade-out"}
## {.section-header background-image="images/3_end.png" background-size="contain" background-color="#1a1a1a" transition="fade-in fade-out"}
## {.section-header background-image="images/4_end.png" background-size="contain" background-color="#1a1a1a" transition="fade-in fade-out"}
## {.section-header background-image="images/5_end.png" background-size="contain" background-color="#1a1a1a" transition="fade-in fade-out"}
