...
- Intentional and consistent names for objects
...
:::{.notes}
- will you have to merge multiple branches together before rolling into repository?<br>
- where are you in the workflow?<br>
...
- Never have branched work away from the main branch too long - don't let perfectionsim hurt you
:::
...
Learn what* you need to*, how you need to by *(Reading, Doing, or Skimming)

:::{.fragment}
Because, sometimes, you may really just need to do more with git
:::
...
:::{.fragment}
*You can find learning resources on this talk's GitHub Repository [here]()
:::
...
- Rec -> actively seek out that info when needed, docs/resources on git are rabbit-holey and ALOT (overwhelm)<br><br>
