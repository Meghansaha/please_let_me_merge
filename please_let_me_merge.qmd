...
## Quick Things to Understand About Git {.content-header background-image="images/content_back.png" background-size="stretch"}
...
## Do Whatever You want {.section-header background-image="images/dwyw.png" background-size="stretch"}
...
## What is a Git Merge? {.content-header background-image="images/content_back.png" background-size="stretch"}

## Why is a Git Merge Scary? {.content-header background-image="images/content_back.png" background-size="stretch"}
